...
<nav className={` bg-[#FBFBFB] transition-all duration-300 ease-in-out border-gray-200 ${sidebarReduced?" lg:pl-[10%]":"2lg:pl-[22%] pl-[25%] "} max-lg:pl-0  border-b shadow-md shadow-slate-100 w-full   absolute top-0  z-30`}>
